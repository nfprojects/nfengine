...
{
    // GCC won't allow us to clobber EBX since its used to store the Global Offset Table (GOT).
    // So we need to lie to GCC and backup/restore EBX without declaring it as clobbered.

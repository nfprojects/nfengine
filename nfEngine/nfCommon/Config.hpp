...
class NFCOMMON_API Config
{
    ...
    void ValueToString(std::stringstream& out, ConfigValuePtr valuePtr, int intend) const;
    void ObjectToString(std::stringstream& out, ConfigObjectNodePtr objectPtr, int intend) const;

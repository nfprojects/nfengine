...
class NFCOMMON_API Config
{
    ...
    void ValueToString(std::string& outputStr, ConfigValuePtr valuePtr, int intend) const;
    void ObjectToString(std::string& outputStr, ConfigObjectNodePtr objectPtr, int intend) const;
...
public:
    ...
    typedef std::function<bool(const ConfigValue& value)> ArrayIterator;

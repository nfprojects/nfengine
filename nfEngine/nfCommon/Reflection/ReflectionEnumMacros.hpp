...
#define NFE_BEGIN_DEFINE_ENUM(T)                                                                        \
    ...
    namespace NFE { namespace RTTI {                                                                    \
        ...
        template<> NFE_API_EXPORT void TypeCreator<T>::FinishInitialization(EnumTypeInfo& typeInfo)     \
        {                                                                                               \
            typeInfo.name = #T;                                                                         \
    ...
    bool T::_InitType(NFE::RTTI::EnumTypeInfo& typeInfo)                                                \
    {                                                                                                   \
 ...
 */
#define NFE_END_DEFINE_ENUM() return true; } // end of T::_InitType

...
NFE_FORCE_INLINE const Vector4 Vector4_Load_Float2_Unsafe(const Float2* src)
{
    return Vector4(reinterpret_cast<const float*>(src));
}

NFE_FORCE_INLINE const Vector4 Vector4_Load_Float3_Unsafe(const Float3* src)
{
    return Vector4(reinterpret_cast<const float*>(src));
}
...
NFE_FORCE_INLINE const Vector4 Vector4_Load_Half2(const Half src[2])
{
#ifdef NFE_USE_FP16C
...
NFE_FORCE_INLINE const Vector4 Vector4_Load_Half4(const Half src[4])
{
#ifdef NFE_USE_FP16C
...
NFE_FORCE_INLINE const Vector4 Vector4_Load_B5G6R5_Norm(const uint16* src)
{
...
NFE_FORCE_INLINE const Vector4 Vector4_Load_4xUint8(const uint8* src)
{
#ifdef NFE_USE_SSE
...
NFE_FORCE_INLINE const Vector4 Vector4_Load_2xUint16_Norm(const uint16* src)
{
#ifdef NFE_USE_SSE
...
NFE_FORCE_INLINE const Vector4 Vector4_Load_4xUint16(const uint16* src)
{
#ifdef NFE_USE_SSE

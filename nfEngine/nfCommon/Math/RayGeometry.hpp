...
NFE_FORCE_INLINE bool RayBoxIntersectInline(const Ray& ray, const Box& box, Vector& dist)
{
...
NFE_FORCE_INLINE bool RayTriangleIntersectInline(const Ray& ray, const Triangle& tri, Vector& dist)
{

...
public:
    ...
    NFE_FORCE_INLINE Vector3x8() = default;
    NFE_FORCE_INLINE Vector3x8(const Vector3x8&) = default;
    NFE_FORCE_INLINE Vector3x8& operator = (const Vector3x8&) = default;

    NFE_FORCE_INLINE static const Vector3x8 Zero()
    {
        return { Vector8::Zero(), Vector8::Zero(), Vector8::Zero() };
    }

    NFE_FORCE_INLINE static const Vector3x8 One()
    {
        return { Vector8(1.0f), Vector8(1.0f), Vector8(1.0f) };
    }

    NFE_FORCE_INLINE Vector3x8(const Vector8& x, const Vector8& y, const Vector8& z)
        : x(x), y(y), z(z)
    {}

    // splat value to all the components
    NFE_FORCE_INLINE explicit Vector3x8(const Vector8& s)
        : x(s), y(s), z(s)
    {}

    // splat single 3D vector
    NFE_FORCE_INLINE explicit Vector3x8(const Vector4& v)
    {
#ifdef NFE_USE_AVX
    ...
    NFE_FORCE_INLINE explicit Vector3x8(const float f)
        : x(f) , y(f) , z(f)
    {}

    // splat single 3D vector
    NFE_FORCE_INLINE explicit Vector3x8(const Float3& v)
        : x(v.x), y(v.y), z(v.z)
    {}

    // build from eight 3D vectors
    NFE_FORCE_INLINE Vector3x8(const Vector4& v0, const Vector4& v1, const Vector4& v2, const Vector4& v3,
    ...
    NFE_FORCE_INLINE void Unpack(Vector4 output[8]) const
    {
#ifdef NFE_USE_AVX
    ...
    NFE_FORCE_INLINE const Vector3x8 operator - () const
    {
        return { -x, -y, -z };
    }

    NFE_FORCE_INLINE const Vector3x8 operator + (const Vector3x8& rhs) const
    {
    ...
    NFE_FORCE_INLINE const Vector3x8 operator * (const Vector8& rhs) const
    {
    ...
    NFE_FORCE_INLINE const Vector3x8 operator * (const float rhs) const
    {
        return { x * rhs, y * rhs, z * rhs };
    }
    ...
    NFE_FORCE_INLINE Vector3x8& operator += (const Vector3x8& rhs)
    {
        x += rhs.x;
        y += rhs.y;
        z += rhs.z;
    ...
    NFE_FORCE_INLINE Vector3x8& operator *= (const Vector8& rhs)
    {
        x *= rhs;
        y *= rhs;
        z *= rhs;
    ...
    NFE_FORCE_INLINE Vector3x8& operator *= (const float rhs)
    {
        x *= rhs;
        y *= rhs;
        z *= rhs;
    ...
    NFE_FORCE_INLINE static const Vector3x8 Reciprocal(const Vector3x8& v)
    {
        return
        {
    ...
    NFE_FORCE_INLINE static const Vector3x8 FastReciprocal(const Vector3x8& v)
    {
        return
        {
    ...
    NFE_FORCE_INLINE static const Vector3x8 MulAndAdd(const Vector3x8& a, const Vector3x8& b, const Vector3x8& c)
    {
        return { Vector8::MulAndAdd(a.x, b.x, c.x), Vector8::MulAndAdd(a.y, b.y, c.y), Vector8::MulAndAdd(a.z, b.z, c.z) };
    }

    NFE_FORCE_INLINE static const Vector3x8 MulAndSub(const Vector3x8& a, const Vector3x8& b, const Vector3x8& c)
    {
        return { Vector8::MulAndSub(a.x, b.x, c.x), Vector8::MulAndSub(a.y, b.y, c.y), Vector8::MulAndSub(a.z, b.z, c.z) };
    }

    NFE_FORCE_INLINE static const Vector3x8 NegMulAndAdd(const Vector3x8& a, const Vector3x8& b, const Vector3x8& c)
    {
        return { Vector8::NegMulAndAdd(a.x, b.x, c.x), Vector8::NegMulAndAdd(a.y, b.y, c.y), Vector8::NegMulAndAdd(a.z, b.z, c.z) };
    }

    NFE_FORCE_INLINE static const Vector3x8 NegMulAndSub(const Vector3x8& a, const Vector3x8& b, const Vector3x8& c)
    {
    ...
    NFE_FORCE_INLINE static const Vector3x8 MulAndAdd(const Vector3x8& a, const Vector8& b, const Vector3x8& c)
    {
        return { Vector8::MulAndAdd(a.x, b, c.x), Vector8::MulAndAdd(a.y, b, c.y), Vector8::MulAndAdd(a.z, b, c.z) };
    }

    NFE_FORCE_INLINE static const Vector3x8 MulAndSub(const Vector3x8& a, const Vector8& b, const Vector3x8& c)
    {
        return { Vector8::MulAndSub(a.x, b, c.x), Vector8::MulAndSub(a.y, b, c.y), Vector8::MulAndSub(a.z, b, c.z) };
    }

    NFE_FORCE_INLINE static const Vector3x8 NegMulAndAdd(const Vector3x8& a, const Vector8& b, const Vector3x8& c)
    {
        return { Vector8::NegMulAndAdd(a.x, b, c.x), Vector8::NegMulAndAdd(a.y, b, c.y), Vector8::NegMulAndAdd(a.z, b, c.z) };
    }

    NFE_FORCE_INLINE static const Vector3x8 NegMulAndSub(const Vector3x8& a, const Vector8& b, const Vector3x8& c)
    {
    ...
    NFE_FORCE_INLINE static const Vector3x8 MulAndAdd(const Vector3x8& a, const Vector3x8& b, const Vector8& c)
    {
        return { Vector8::MulAndAdd(a.x, b.x, c), Vector8::MulAndAdd(a.y, b.y, c), Vector8::MulAndAdd(a.z, b.z, c) };
    }

    NFE_FORCE_INLINE static const Vector3x8 MulAndSub(const Vector3x8& a, const Vector3x8& b, const Vector8& c)
    {
        return { Vector8::MulAndSub(a.x, b.x, c), Vector8::MulAndSub(a.y, b.y, c), Vector8::MulAndSub(a.z, b.z, c) };
    }

    NFE_FORCE_INLINE static const Vector3x8 NegMulAndAdd(const Vector3x8& a, const Vector3x8& b, const Vector8& c)
    {
        return { Vector8::NegMulAndAdd(a.x, b.x, c), Vector8::NegMulAndAdd(a.y, b.y, c), Vector8::NegMulAndAdd(a.z, b.z, c) };
    }

    NFE_FORCE_INLINE static const Vector3x8 NegMulAndSub(const Vector3x8& a, const Vector3x8& b, const Vector8& c)
    {
    ...
    NFE_FORCE_INLINE static const Vector3x8 MulAndAdd(const Vector3x8& a, const Vector8& b, const Vector8& c)
    {
        return { Vector8::MulAndAdd(a.x, b, c), Vector8::MulAndAdd(a.y, b, c), Vector8::MulAndAdd(a.z, b, c) };
    }

    NFE_FORCE_INLINE static const Vector3x8 MulAndSub(const Vector3x8& a, const Vector8& b, const Vector8& c)
    {
        return { Vector8::MulAndSub(a.x, b, c), Vector8::MulAndSub(a.y, b, c), Vector8::MulAndSub(a.z, b, c) };
    }

    NFE_FORCE_INLINE static const Vector3x8 NegMulAndAdd(const Vector3x8& a, const Vector8& b, const Vector8& c)
    {
        return { Vector8::NegMulAndAdd(a.x, b, c), Vector8::NegMulAndAdd(a.y, b, c), Vector8::NegMulAndAdd(a.z, b, c) };
    }

    NFE_FORCE_INLINE static const Vector3x8 NegMulAndSub(const Vector3x8& a, const Vector8& b, const Vector8& c)
    {
    ...
    // 3D dot product
    NFE_FORCE_INLINE static const Vector8 Dot(const Vector3x8& a, const Vector3x8& b)
    {
    ...
    // 3D cross product
    NFE_FORCE_INLINE static const Vector3x8 Cross(const Vector3x8& a, const Vector3x8& b)
    {
        return {
    ...
    NFE_FORCE_INLINE const Vector8 SqrLength() const
    {
        return Dot(*this, *this);
    }

    NFE_FORCE_INLINE const Vector3x8 Normalized() const
    {
    ...
    NFE_FORCE_INLINE static const Vector3x8 Min(const Vector3x8& a, const Vector3x8& b)
    {
        return { Vector8::Min(a.x, b.x), Vector8::Min(a.y, b.y), Vector8::Min(a.z, b.z) };
    }

    NFE_FORCE_INLINE static const Vector3x8 Max(const Vector3x8& a, const Vector3x8& b)
    {

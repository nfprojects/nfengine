...
int64 FileBuffered::GetPos() const
{
    ...
    // When EOF is reached, there is and offset in the buffer, otherwise it's equal 0
    int64 pos;
    int64 filePos = mFile.GetPos();
    pos = filePos - FILE_BUFFERED_BUFFER_SIZE;
    int64 posInBuffer = mBufferOccupied - mBufferEOFOffset;
    pos = pos + posInBuffer;

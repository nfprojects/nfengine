...
public:
     ...
     */
    uint64_t const GetFreeMemoryKb();
     ...
     * Get class fields
     */
    std::string const GetCPUBrand();
    uint64_t const GetCPUCoreNo();
    uint64_t const GetPageSize();
    uint64_t const GetCacheLineSize();
    uint64_t const GetCPUSpeedMHz();
    uint64_t const GetMemTotalPhysKb();
    uint64_t const GetMemTotalVirtKb();
    uint64_t const GetMemFreePhysKb();
    uint64_t const GetMemFreeVirtKb();

    std::string const GetAllInfoString();
};

...
private:
    ...
    // Allocate element in the linked list. This is O(1)
    NFE_INLINE ElementID AllocateElement();

    // Put a free element in the linked list. This is O(1)
    ...
    ElementID mNextFree;        // next free element in the free list
    ...
    // TODO keep buckets list independent of elements list (to save some memory)
};

...
public:
    ...
    /**
     * Remove all the keys and free allocated memory.
     ...
     * @note    This operation can be slow if the set is sparse.
     */
...
private:
    ...
    // allocate space for insertion or replacement
    InsertResult InsertOrReplace_Internal(const KeyType& key);

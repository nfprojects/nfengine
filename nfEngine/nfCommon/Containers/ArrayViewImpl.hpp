...
template<typename ElementType>
typename int32 ArrayView<ElementType>::ConstIterator::operator-(const ConstIterator& rhs) const
{
...
template<typename ElementType>
typename int32 ArrayView<ElementType>::Iterator::operator-(const Iterator& rhs) const
{
...
{
    return Iterator(mArray, mIndex + offset);
}

...
public:
    ...
    using InsertResult = InternalSet::InsertResult;
    using ConstIterator = InternalSet::ConstIterator;
    using Iterator = InternalSet::Iterator;
    ...
    NFE_INLINE InsertResult Insert(KeyType&& key);

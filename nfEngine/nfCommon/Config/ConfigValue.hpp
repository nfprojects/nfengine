...
public:
    ...
    template<> NFE_INLINE bool Is<int8>() const { return type == Type::Int8; }
    template<> NFE_INLINE bool Is<uint8>() const { return type == Type::Uint8; }
    template<> NFE_INLINE bool Is<int16>() const { return type == Type::Int16; }
    template<> NFE_INLINE bool Is<uint16>() const { return type == Type::Uint16; }
    template<> NFE_INLINE bool Is<int32>() const { return type == Type::Int32; }
    template<> NFE_INLINE bool Is<uint32>() const { return type == Type::Uint32; }
    template<> NFE_INLINE bool Is<int64>() const { return type == Type::Int64; }
    template<> NFE_INLINE bool Is<uint64>() const { return type == Type::Uint64; }
    template<> NFE_INLINE bool Is<bool>() const { return type == Type::Bool; }
    template<> NFE_INLINE bool Is<float>() const { return type == Type::Float; }
    ...
    template<> NFE_INLINE int8 Get<int8>() const { return intData8; }
    template<> NFE_INLINE uint8 Get<uint8>() const { return uintData8; }
    template<> NFE_INLINE int16 Get<int16>() const { return intData16; }
    template<> NFE_INLINE uint16 Get<uint16>() const { return uintData16; }
    template<> NFE_INLINE int32 Get<int32>() const { return intData32; }
    template<> NFE_INLINE uint32 Get<uint32>() const { return uintData32; }
    template<> NFE_INLINE int64 Get<int64>() const { return intData64; }
    template<> NFE_INLINE uint64 Get<uint64>() const { return uintData64; }
    template<> NFE_INLINE bool Get<bool>() const { return boolData; }
    template<> NFE_INLINE float Get<float>() const { return floatData; }
    template<> NFE_INLINE double Get<double>() const { return doubleData; }
    template<> NFE_INLINE const char* Get<const char*>() const { return stringData; }
};

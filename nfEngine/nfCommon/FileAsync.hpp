...
#if defined(WIN32)
    HANDLE mFile;
    static HANDLE mDecayCallbackStart;
    static HANDLE mDecayCallbackFinish;
    static HANDLE mCallbackThread;  //< Remote thread used for async jobs' callbacks
    static unsigned int mReferenceCounter;

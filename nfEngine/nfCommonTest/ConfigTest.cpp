...
TEST(Config, ValueCheck)
{
    ...
    bool boolOccurred = false;
    bool floatOccurred = false;
    bool stringOccurred = false;
...
TEST(Config, DataTranslator)
{
    ...
    DataTranslator<TestStruct> translator;
    translator.Add("integerValue", &TestStruct::integerValue);
    translator.Add("booleanValue", &TestStruct::booleanValue);
    translator.Add("floatValue", &TestStruct::floatValue);
    translator.Add("stringValue", &TestStruct::stringValue);

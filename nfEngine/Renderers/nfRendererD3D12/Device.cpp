...
bool Device::GetDeviceInfo(DeviceInfo& info)
{
    ...
    info.misc =
        ...
        ", Dedicated Video Memory: " + ToString(adapterDesc.DedicatedVideoMemory >> 10) + " KB"
        ", Dedicated System Memory: " + ToString(adapterDesc.DedicatedSystemMemory >> 10) + " KB"
        ", Shared System Memory: " + ToString(adapterDesc.SharedSystemMemory >> 10) + " KB";
    ...
    {
        info.features.PushBack("TiledResourcesTier=" +
                               ToString(static_cast<int>(d3d12options.TiledResourcesTier)));
        info.features.PushBack("ResourceBindingTier=" +
                               ToString(static_cast<int>(d3d12options.ResourceBindingTier)));
        info.features.PushBack("ResourceHeapTier=" +
                               ToString(static_cast<int>(d3d12options.ResourceHeapTier)));

        info.features.PushBack("DoublePrecisionFloatShaderOps=" +
                               ToString(d3d12options.DoublePrecisionFloatShaderOps));
        info.features.PushBack("OutputMergerLogicOp=" +
                               ToString(d3d12options.OutputMergerLogicOp));
        info.features.PushBack("PSSpecifiedStencilRefSupported=" +
                               ToString(d3d12options.PSSpecifiedStencilRefSupported));
        info.features.PushBack("TypedUAVLoadAdditionalFormats=" +
                               ToString(d3d12options.TypedUAVLoadAdditionalFormats));
        info.features.PushBack("ROVsSupported=" +
                               ToString(d3d12options.ROVsSupported));
        info.features.PushBack("ConservativeRasterizationTier=" +
                               ToString(d3d12options.ConservativeRasterizationTier));
        info.features.PushBack("MaxGPUVirtualAddressBitsPerResource=" +
                               ToString(d3d12options.MaxGPUVirtualAddressBitsPerResource));
        info.features.PushBack("StandardSwizzle64KBSupported=" +
                               ToString(d3d12options.StandardSwizzle64KBSupported));
        info.features.PushBack("CrossAdapterRowMajorTextureSupported=" +
                               ToString(d3d12options.CrossAdapterRowMajorTextureSupported));

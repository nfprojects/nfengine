...
#define NFE_MAX_NUM_MIPMAPS 16

    D3D12_PLACED_SUBRESOURCE_FOOTPRINT layouts[NFE_MAX_NUM_MIPMAPS];
    UINT64 rowSizesInBytes[NFE_MAX_NUM_MIPMAPS];
    UINT numRows[NFE_MAX_NUM_MIPMAPS];
    gDevice->GetDevice()->GetCopyableFootprints(&d3dResDesc, 0, desc.mipmaps, 0, layouts, numRows, rowSizesInBytes, &requiredSize);

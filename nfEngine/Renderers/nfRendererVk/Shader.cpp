...
void Shader::ParseResourceSlots()
{
    ...
    NFE_LOG_DEBUG("Disassembly: %s", disasmStr.c_str());
    Common::StringView shaderDisassembly(disasmStr.c_str(), disasmStr.size());
    ...
    NFE_LOG_DEBUG("Found %d names and %d decorates", names.Size(), decorates.Size());

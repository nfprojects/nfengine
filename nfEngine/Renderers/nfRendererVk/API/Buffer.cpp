...
bool Buffer::Init(DevicePtr& device, const BufferDesc& desc)
{
    mDevicePtr = device;
...
leave:
    ...
    NFE_LOG_INFO("%u-byte %s Buffer created successfully", desc.size, bufferModeStr.Str());
    return true;
}

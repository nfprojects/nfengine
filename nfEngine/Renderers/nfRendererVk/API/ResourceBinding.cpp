...
bool ResourceBindingSet::Init(DevicePtr& device, const ResourceBindingSetDesc& desc)
{
    mDevicePtr = device;
...
bool ResourceBindingLayout::Init(DevicePtr& device, const ResourceBindingLayoutDesc& desc)
{
    mDevicePtr = device;
...
bool ResourceBindingInstance::Init(DevicePtr& device, const ResourceBindingSetPtr& bindingSet)
{
    mDevicePtr = device;

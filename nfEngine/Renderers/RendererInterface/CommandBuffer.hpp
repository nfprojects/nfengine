...
public:
     ...
     * @param slot               Target slot within binding set layout.
     * @param bindingSetInstance Binding set instance to be bound to the pipeline.
     */
    virtual void SetBindingSet(size_t slot, IResourceBindingInstance* bindingSetInstance) = 0;

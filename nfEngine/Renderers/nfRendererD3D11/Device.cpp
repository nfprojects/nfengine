...
bool Device::GetDeviceInfo(DeviceInfo& info)
{
    ...
    info.misc =
        ...
        ", Dedicated Video Memory: " + Common::ToString(adapterDesc.DedicatedVideoMemory >> 10) + " KB"
        ", Dedicated System Memory: " + Common::ToString(adapterDesc.DedicatedSystemMemory >> 10) + " KB"
        ", Shared System Memory: " + Common::ToString(adapterDesc.SharedSystemMemory >> 10) + " KB";

 ...
 * @brief  OpenGL Master Context singleton definitions
 */
...
bool MasterContext::Init()
{
    ...
    mData = reinterpret_cast<void*>(new ContextDataGLX(data));
...
void MasterContext::Release()
{
    if (mData)
    {
        ContextDataGLX* data = reinterpret_cast<ContextDataGLX*>(mData);

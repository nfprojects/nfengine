                             ...
                             float dt)
{
    ...
    else
    {
        ...
        mFrustum.verticies[0] = pos + mOrtho.nearDist * zAxis + mOrtho.left * xAxis  + mOrtho.bottom *
                                yAxis;
        mFrustum.verticies[1] = pos + mOrtho.nearDist * zAxis + mOrtho.right * xAxis + mOrtho.bottom *
                                yAxis;
        mFrustum.verticies[2] = pos + mOrtho.nearDist * zAxis + mOrtho.left * xAxis  + mOrtho.top *
                                yAxis;
        mFrustum.verticies[3] = pos + mOrtho.nearDist * zAxis + mOrtho.right * xAxis + mOrtho.top *
                                yAxis;

        mFrustum.verticies[4] = pos + mOrtho.farDist * zAxis + mOrtho.left * xAxis   + mOrtho.bottom *
                                yAxis;
        mFrustum.verticies[5] = pos + mOrtho.farDist * zAxis + mOrtho.right * xAxis  + mOrtho.bottom *
                                yAxis;
        mFrustum.verticies[6] = pos + mOrtho.farDist * zAxis + mOrtho.left * xAxis   + mOrtho.top *
                                yAxis;
        mFrustum.verticies[7] = pos + mOrtho.farDist * zAxis + mOrtho.right * xAxis  + mOrtho.top *
                                yAxis;
    }

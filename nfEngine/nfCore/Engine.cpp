                     ...
                     const UpdateRequest* pUpdateRequests, uint32 updateRequestsNum)
{
    ...
    if (!(MemoryCheck(pDrawRequests, sizeof(DrawRequest)*drawRequestsNum) & ACCESS_READ))
    {
    ...
    if (!(MemoryCheck(pUpdateRequests, sizeof(UpdateRequest)*updateRequestsNum) & ACCESS_READ))
    {

...
void RendererSystem::Render(EntityManager* entityManager, Renderer::View* view)
{
    ...
    auto camera = entityManager->GetComponent<CameraComponent>(view->GetCameraEntity());
    auto cameraTransform = entityManager->GetComponent<TransformComponent>(view->GetCameraEntity());
    auto cameraBody = entityManager->GetComponent<BodyComponent>(view->GetCameraEntity());
...
void RendererSystem::Update(EntityManager* entityManager, float dt)
{
    ...
    entityManager->ForEach<TransformComponent, MeshComponent, BodyComponent>(
    ...
    entityManager->ForEach<TransformComponent, CameraComponent, BodyComponent>(
        [this](EntityID entity,
        TransformComponent& transform,

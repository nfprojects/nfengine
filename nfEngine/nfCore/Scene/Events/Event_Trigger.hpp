...
public:
    ...
    Event_Trigger(Entity& sourceEntity, Entity& targetEntity, Type type);
    Event_Trigger(const Event_Trigger&) = default;
    Event_Trigger(Event_Trigger&&) = default;
    Event_Trigger& operator = (const Event_Trigger&) = default;

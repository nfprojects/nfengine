...
#include "../../Physics/PhysicsProxies.hpp"
 ...
 */
class CORE_API NFE_ALIGN(16) BodyComponent final
    : public IComponent
    , public Common::Aligned<16>
{
    NFE_DECLARE_POLYMORPHIC_CLASS(BodyComponent)
...
private:
    ...
    Physics::ProxyID mPhysicsProxy;

    // get physics system managing this component
    PhysicsSystem* GetPhysicsSystem() const;

    // get physics scene managing this component's proxy
    Physics::IPhysicsScene* GetPhysicsScene() const;

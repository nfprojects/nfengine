...
bool View::InitImGui()
{
    ...
    io.Fonts->AddFontFromFileTTF("c:\\Windows\\Fonts\\Tahoma.ttf", 16.0f); // TODO
...
void View::DrawGui()
{
    ...
    {
        if (!ImGui::Begin("View properties", &guiOpended, ImVec2(300, 200), 0.8f))
        {
        ...
        if (ImGui::CollapsingHeader("ImGui style editor", nullptr, true, true))

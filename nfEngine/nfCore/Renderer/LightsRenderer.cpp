...
LightsRenderer::LightsRenderer()
{
    ...
    mFullscreenQuadVS = static_cast<Multishader*>(rm->GetResource("FullScreenQuadVS",
                                                                  ResourceType::Shader));
    mAmbientLightPS = static_cast<Multishader*>(rm->GetResource("AmbientLightPS",
                                                                ResourceType::Shader));
    ...
    mSpotLightShaderProgram = static_cast<MultiShaderProgram*>(rm->GetResource("SpotLight", ResourceType::ShaderProgram));
    mSpotLightShaderProgram->AddRef(this);
    rm->WaitForResource(mSpotLightShaderProgram);

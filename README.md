...
* **BUILD_PLATFORM** - specifies different name for build platform. Keep in mind, this does NOT enable different version build (ex. 32-bit on 64-bit system).

Example - forcing Debug build on build platform renamed to x86_64:

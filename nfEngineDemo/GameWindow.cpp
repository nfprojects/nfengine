...
void GameWindow::InitCamera()
{
    ...
    // camera entity must be created from Game Object resource
    {
        ...
        UniquePtr<CameraComponent> camera(new CameraComponent);
        ...
        UniquePtr<ControllerComponent> controller(new ControllerComponent);
        ...
        UniquePtr<TriggerComponent> trigger(new TriggerComponent);

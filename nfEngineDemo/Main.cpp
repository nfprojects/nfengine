...
private:
    ...
    Scene::GameObjectInstance* mCameraGameObject;

public:
    NFE_INLINE Scene::SceneManager* GetScene() const { return mScene.get(); }
    NFE_INLINE Renderer::View* GetView() const { return mView.get(); }
    NFE_INLINE Scene::GameObjectInstance* GetCameraGameObject() const { return mCameraGameObject; }
    ...
    void SetUpScene(int sceneId = 0, CustomWindow* parent = nullptr)
    {
        ...
        GameObject* go = 
        mCameraGameObject = mScene->GetGameObjectSystem()->SpawnGameObject()
    }

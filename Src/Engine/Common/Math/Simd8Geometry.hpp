...
NFE_FORCE_INLINE const VectorBool8 Intersect_BoxRay_Simd8_Octant(
...
NFE_FORCE_INLINE const VectorBool8 Intersect_BoxRay_Simd8(
    const Vector3x8& rayInvDir,
    const Vector3x8& rayOriginDivDir,
    const Box_Simd8& box,
    const Vector8& maxDistance,
...
NFE_FORCE_INLINE const VectorBool8 Intersect_BoxRay_TwoSided_Simd8(
    const Vector3x8& rayInvDir,
    const Vector3x8& rayOriginDivDir,
    const Box_Simd8& box,
    const Vector8& maxDistance,
...
NFE_INLINE const VectorBool8 Intersect_TriangleRay_Simd8(

...
struct SphericalQuad
{
    ...
    NFE_INLINE void Init(const Vector4& s, const Vector4& ex, const Vector4& ey, const Vector4& o);
    NFE_INLINE const Vector4 Sample(float u, float v, float& outPdf) const;
};

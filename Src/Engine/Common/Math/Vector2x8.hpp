 ...
 */
class NFE_ALIGN(32) Vector2x8
{
public:
    Vector8 x;
    Vector8 y;

    NFE_FORCE_INLINE Vector2x8() = default;
    NFE_FORCE_INLINE Vector2x8(const Vector2x8&) = default;
    NFE_FORCE_INLINE Vector2x8& operator = (const Vector2x8&) = default;

    NFE_FORCE_INLINE static const Vector2x8 Zero()
    {
        return { Vector8::Zero(), Vector8::Zero() };
    }

    NFE_FORCE_INLINE static const Vector2x8 One()
    {
        return { Vector8(1.0f), Vector8(1.0f) };
    }

    NFE_FORCE_INLINE explicit Vector2x8(const float scalar)
        : x(scalar), y(scalar)
    { }

    NFE_FORCE_INLINE Vector2x8(const Vector8& x, const Vector8& y)
        : x(x), y(y)
    { }

    // splat single 3D vector
    NFE_FORCE_INLINE explicit Vector2x8(const Vector4& v)
    {
#ifdef NFE_USE_AVX
    ...
    NFE_FORCE_INLINE const Vector2x8 operator + (const Vector2x8& rhs) const
    {
    ...
    NFE_FORCE_INLINE const Vector2x8 operator * (const Vector8& rhs) const
    {
        return { x * rhs, y * rhs };
    }
    ...
    NFE_FORCE_INLINE const Vector2x8 operator * (const float rhs) const
    {
        return { x * rhs, y * rhs };
    }
    ...
    NFE_FORCE_INLINE Vector2x8& operator += (const Vector2x8& rhs)
    {
        x += rhs.x;
        y += rhs.y;
        return *this;
    ...
    NFE_FORCE_INLINE Vector2x8& operator *= (const float rhs)
    {
        x *= rhs;
        y *= rhs;
        return *this;
    ...
    NFE_FORCE_INLINE static const Vector2x8 FastReciprocal(const Vector2x8& v)
    {
        return
        {
    ...
    NFE_FORCE_INLINE static const Vector2x8 MulAndAdd(const Vector2x8& a, const Vector2x8& b, const Vector2x8& c)
    {
        return
        {
    ...
    NFE_FORCE_INLINE static const Vector2x8 MulAndSub(const Vector2x8& a, const Vector2x8& b, const Vector2x8& c)
    {
        return
        {
    ...
    NFE_FORCE_INLINE static const Vector2x8 NegMulAndAdd(const Vector2x8& a, const Vector2x8& b, const Vector2x8& c)
    {
        return
        {
    ...
    NFE_FORCE_INLINE static const Vector2x8 NegMulAndSub(const Vector2x8& a, const Vector2x8& b, const Vector2x8& c)
    {
        return
        {
    ...
    // dot product
    NFE_FORCE_INLINE static const Vector8 Dot(const Vector2x8& a, const Vector2x8& b)
    {
    ...
    NFE_FORCE_INLINE static const Vector2x8 Min(const Vector2x8& a, const Vector2x8& b)
    {
        return { Vector8::Min(a.x, b.x), Vector8::Min(a.y, b.y) };
    }

    NFE_FORCE_INLINE static const Vector2x8 Max(const Vector2x8& a, const Vector2x8& b)
    {
...
NFE_FORCE_INLINE const Vector2x8 operator * (const float lhs, const Vector2x8 rhs)
{
